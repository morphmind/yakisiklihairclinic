export const en = {
  ...
  hairAnalysis: {
    toast: {
      ...
      success: {
        title: "Success",
        description: "Your analysis form has been submitted successfully. We will contact you via WhatsApp.",
      },
      loading: {
        title: "Sending",
        description: "Processing your analysis form...",
      }
    },
    ...
    steps: {
      ...
      previous: {
        ...
        doctorMessage: 'Understanding your hair transplant history is crucial for planning your next procedure. If you\'ve had previous treatments, we need to carefully evaluate the donor area and ensure optimal results for any additional procedures.',
        options: {
          yes: {
            title: 'Yes',
